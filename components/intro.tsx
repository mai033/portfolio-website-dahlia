    ...
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          >
            <Image
              src="/Headshot-blue.png"
              alt="Dahlia Mai portrait"
              width="192"
              height="192"
              quality="95"
              priority={true}
      ...
      >
        <span className="font-bold">Hi, I'm Dahlia,</span> a{' '}
        <span className="font-bold">full-stack software engineer</span> with a
        passion for creating <span className="italic">websites & apps</span>. I
        specialize in <span className="underline">React</span>,{' '}
      ...
      >
        ...
        <a
          ...
          focus:scale-[1.15] hover:scale-[1.15] active:scale-105 hover:text-gray-950 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://www.linkedin.com/in/mai-dahlia/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
